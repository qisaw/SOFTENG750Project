...
gauge how much of the code can be parallelized. This project will attempt to
analyse parallelizability at a superficial level and pave the way for more
...
\section{Motivation}
In terms of frequency, processors are beginning to peak at their physical
...
visualise the benefits of parallelizing a block of code. The point of this
...
of selected loops based on dependency analysis. This has been done using both static
...
a fully functional set of capabilities.

The long term scope of the project is to create a tool that outputs a meaningful
analysis the amount of parallelizable code and the resulting speedup given a
java directory as input. This will be achieved at first by obtaining a
superficial count of how many atomic operations occur in a block of code. The
assumptions is that atomic lines of code cannot be parallelized internally while
...
\item Get code from previous assignments and run it through the program. Output
...
\item \textbf{Milestone 3} - 20/05/2014\\*
User test completed\\*
All tests pass\\*
\end{description}
