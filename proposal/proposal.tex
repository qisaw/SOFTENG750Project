...
java directory as input. This will be achieved at first by importing the code into PDStore, parsing through the abstract syntax trees it creates and obtaining a
