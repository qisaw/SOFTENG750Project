...
analysis of the amount of parallelizable code and the resulting speedup for a section of code selected by the user. This will be achieved at first by obtaining a
